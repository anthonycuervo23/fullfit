...
void _mealSerialize(
  ...
  writer.writeLong(offsets[0], object.cookingTime);
  writer.writeLong(offsets[1], object.id);
  writer.writeString(offsets[2], object.image);
  writer.writeString(offsets[3], object.name);
  writer.writeLong(offsets[4], object.servings);
...
Meal _mealDeserialize(
  ...
  final object = Meal(
    cookingTime: reader.readLongOrNull(offsets[0]),
    id: reader.readLongOrNull(offsets[1]),
    image: reader.readStringOrNull(offsets[2]),
    name: reader.readStringOrNull(offsets[3]),
    servings: reader.readLongOrNull(offsets[4]),
...
extension MealQueryFilter on QueryBuilder<Meal, Meal, QFilterCondition> {
  QueryBuilder<Meal, Meal, QAfterFilterCondition> cookingTimeIsNull() {
  ...
  QueryBuilder<Meal, Meal, QAfterFilterCondition> cookingTimeIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Meal, Meal, QAfterFilterCondition> cookingTimeEqualTo(
      int? value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Meal, Meal, QAfterFilterCondition> cookingTimeGreaterThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Meal, Meal, QAfterFilterCondition> cookingTimeLessThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Meal, Meal, QAfterFilterCondition> cookingTimeBetween(
    int? lower,
    int? upper, {
  ...
  QueryBuilder<Meal, Meal, QAfterFilterCondition> idIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'id',
      ));
  ...
  QueryBuilder<Meal, Meal, QAfterFilterCondition> idIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'id',
      ));
  ...
  QueryBuilder<Meal, Meal, QAfterFilterCondition> idEqualTo(int? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'id',
        value: value,
  ...
  QueryBuilder<Meal, Meal, QAfterFilterCondition> imageContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Meal, Meal, QAfterFilterCondition> imageMatches(String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Meal, Meal, QAfterFilterCondition> servingsIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'servings',
      ));
  ...
  QueryBuilder<Meal, Meal, QAfterFilterCondition> servingsIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'servings',
      ));
  ...
  QueryBuilder<Meal, Meal, QAfterFilterCondition> servingsEqualTo(int? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'servings',
        value: value,
  ...
  QueryBuilder<Meal, Meal, QAfterFilterCondition> servingsGreaterThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Meal, Meal, QAfterFilterCondition> servingsLessThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Meal, Meal, QAfterFilterCondition> servingsBetween(
    int? lower,
    int? upper, {
    bool includeLower = true,
    bool includeUpper = true,
